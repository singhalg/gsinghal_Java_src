...
public class PolynomialTest {
	...
	(Polynomial) n = synthPoly(n);
	private Polynomial p0 = new Polynomial();
	private Polynomial p10 = synthPoly(new double[] {  7,  5, -2,  5});
	...
	public void testtoString() {
		...
		Polynomial p10Deriv = synthPoly(new double[] {5,-4,15});
		assertEquals(p10Deriv, p10.derivative());
		System.out.println("derivative of p10 = " + p10.derivative().toString());
		assertEquals(49.0, p10.evaluate(2.0), .01);
	}
	@Test
	public void testSum() {
	...
	// TA: Seriously!?!?!
	@Test //TA: Don't change the tests...
